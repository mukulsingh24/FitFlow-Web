        ...
        <div className="overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/10 backdrop-blur-xl shadow-2xl p-12 relative group">
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <button 
              ...
              className="relative flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/5 py-3.5 px-4 text-base font-medium text-white hover:bg-white/10 hover:border-white/20 transition-all duration-200 group"
            >
